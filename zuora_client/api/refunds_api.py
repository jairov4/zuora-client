...
class RefundsApi(object):
    ...
    def d_elete_refund(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Deletes a refund. You can delete a refund with the Canceled or Error status.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.d_elete_refund(refund_id, async=True)
        >>> result = thread.get()
    ...
    def d_elete_refund_with_http_info(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Deletes a refund. You can delete a refund with the Canceled or Error status.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.d_elete_refund_with_http_info(refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about a specific refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund(refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_with_http_info(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about a specific refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_with_http_info(refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_item_part(self, itempartid, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** The Invoice Item Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at  [Zuora Global Support](http://support.zuora.com/).    Retrieves the information about a specific refund part item. A refund part item is a single line item in a refund part. A refund part can consist of several different types of items.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_item_part(itempartid, refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_item_part_with_http_info(self, itempartid, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** The Invoice Item Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at  [Zuora Global Support](http://support.zuora.com/).    Retrieves the information about a specific refund part item. A refund part item is a single line item in a refund part. A refund part can consist of several different types of items.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_item_part_with_http_info(itempartid, refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_item_parts(self, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** The Invoice Item Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at  [Zuora Global Support](http://support.zuora.com/).  Retrieves the information about all items of a refund part. A refund part item is a single line item in a refund part. A refund part can consist of several different types of items.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_item_parts(refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_item_parts_with_http_info(self, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** The Invoice Item Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at  [Zuora Global Support](http://support.zuora.com/).  Retrieves the information about all items of a refund part. A refund part item is a single line item in a refund part. A refund part can consist of several different types of items.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_item_parts_with_http_info(refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_part(self, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about a specific refund part.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_part(refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_part_with_http_info(self, refundpartid, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about a specific refund part.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_part_with_http_info(refundpartid, refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_parts(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about all parts of a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_parts(refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refund_parts_with_http_info(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about all parts of a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refund_parts_with_http_info(refund_id, async=True)
        >>> result = thread.get()
    ...
    def g_et_refunds_with_http_info(self, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves the information about all refunds. Two types of refunds are available, electronic refunds and external refunds.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.g_et_refunds_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def object_delete_refund(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_delete_refund(id, async=True)
        >>> result = thread.get()
    ...
    def object_delete_refund_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_delete_refund_with_http_info(id, async=True)
        >>> result = thread.get()
    ...
    def object_get_refund(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_get_refund(id, async=True)
        >>> result = thread.get()
    ...
    def object_get_refund_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_get_refund_with_http_info(id, async=True)
        >>> result = thread.get()
    ...
    def object_post_refund(self, create_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_post_refund(create_request, async=True)
        >>> result = thread.get()
    ...
    def object_post_refund_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_post_refund_with_http_info(create_request, async=True)
        >>> result = thread.get()
    ...
    def object_put_refund(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_put_refund(id, modify_request, async=True)
        >>> result = thread.get()
    ...
    def object_put_refund_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.object_put_refund_with_http_info(id, modify_request, async=True)
        >>> result = thread.get()
    ...
    def p_ut_cancel_refund(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Cancels a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.p_ut_cancel_refund(refund_id, async=True)
        >>> result = thread.get()
    ...
    def p_ut_cancel_refund_with_http_info(self, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Cancels a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.p_ut_cancel_refund_with_http_info(refund_id, async=True)
        >>> result = thread.get()
    ...
    def p_ut_update_refund(self, body, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Updates the basic and finance information about a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.p_ut_update_refund(body, refund_id, async=True)
        >>> result = thread.get()
    ...
    def p_ut_update_refund_with_http_info(self, body, refund_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Updates the basic and finance information about a refund.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.p_ut_update_refund_with_http_info(body, refund_id, async=True)
        >>> result = thread.get()
