...
class POSTPaymentMethodRequest(object):
    ...
    def __init__(self, baid=None, email=None, preapproval_key=None, account_key=None, auth_gateway=None, make_default=False, type=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["PayPalEC", "PayPalNativeEC", "PayPalAdaptive"]  # noqa: E501
