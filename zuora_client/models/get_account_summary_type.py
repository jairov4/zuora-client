...
class GETAccountSummaryType(object):
    ...
    def usage(self):
        ...
        Container for usage data. Only returns the last 6 months of usage.  **Note:** If the [Real-Time Usage Rating](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/Real-Time_Usage_Rating) feature is enabled, no usage data is returned in the response body field. To retrive usage data information, you can use the [Usage (with Real-Time Rating)](https://www.zuora.com/developer/real-time-usage-rating-api/#tag/Usage-(with-Real-Time-Rating)) operations.   # noqa: E501
