...
class GETPublicEmailTemplateResponse(object):
    ...
    def from_name(self, from_name):
        ...
        :type: str
        """
        if from_name is not None and len(from_name) > 50:
    ...
    def id(self):
        ...
        The filter rule associated with this notification definition.  # noqa: E501
    ...
    def is_html(self):
        ...
        Specified whether the style of email body is HTML.  # noqa: E501
    ...
    def updated_on(self):
        ...
        The time when the notification definition was updated. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00  # noqa: E501
