...
class POSTPublicNotificationDefinitionRequest(object):
    ...
    def __init__(self, active=True, callout=None, callout_active=False, communication_profile_id=None, description=None, email_active=False, email_template_id=None, event_type_name=None, filter_rule=None, filter_rule_params=None, name=None):  # noqa: E501
