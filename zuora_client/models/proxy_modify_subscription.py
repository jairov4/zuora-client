...
class ProxyModifySubscription(object):
    ...
    def service_activation_date(self):
        """Gets the service_activation_date of this ProxyModifySubscription.  # noqa: E501
         ...
         The date when the subscription is activated. This field can be updated when **Status** is `Draft`. **Character limit**: 29   # noqa: E501
