...
class GETSubscriptionTypeWithSuccess(object):
    ...
    def status(self):
        ...
        Subscription status; possible values are:  * `Draft` * `PendingActivation` * `PendingAcceptance` * `Active` * `Cancelled` * `Suspended` (This value is in Limited Availability.)   # noqa: E501
