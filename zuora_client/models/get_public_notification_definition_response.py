...
class GETPublicNotificationDefinitionResponse(object):
    ...
    def __init__(self, active=None, callout=None, callout_active=None, communication_profile_id=None, created_by=None, created_on=None, description=None, email_active=None, email_template_id=None, event_type_name=None, filter_rule=None, filter_rule_params=None, id=None, name=None, updated_by=None, updated_on=None):  # noqa: E501
