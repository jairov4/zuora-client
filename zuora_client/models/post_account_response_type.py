...
class POSTAccountResponseType(object):
    ...
    def __init__(self, account_id=None, account_number=None, contracted_mrr=None, credit_memo_id=None, invoice_id=None, paid_amount=None, payment_id=None, payment_method_id=None, subscription_id=None, subscription_number=None, success=None, total_contracted_value=None):  # noqa: E501
