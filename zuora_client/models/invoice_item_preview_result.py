...
class InvoiceItemPreviewResult(object):
    ...
    def __init__(self, additional_info=None, amount_without_tax=None, applied_to_charge_number=None, charge_description=None, charge_name=None, charge_number=None, processing_type=None, product_name=None, product_rate_plan_charge_id=None, service_end_date=None, service_start_date=None, subscription_number=None, tax_amount=None):  # noqa: E501
