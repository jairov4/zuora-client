...
class AccountCreditCardHolder(object):
    ...
    def address_line1(self, address_line1):
        ...
        :type: str
        """
        if address_line1 is not None and len(address_line1) > 255:
    ...
    def address_line2(self, address_line2):
        ...
        :type: str
        """
        if address_line2 is not None and len(address_line2) > 255:
    ...
    def card_holder_name(self, card_holder_name):
        ...
        :type: str
        """
        if card_holder_name is not None and len(card_holder_name) > 50:
    ...
    def zip_code(self, zip_code):
        ...
        :type: str
        """
        if zip_code is not None and len(zip_code) > 20:
