...
class ProxyGetPaymentMethodSnapshot(object):
    ...
    def bank_transfer_type(self, bank_transfer_type):
        ...
        :type: str
        """
        allowed_values = ["AutomatischIncasso", "LastschriftDE", "LastschriftAT", "DemandeDePrelevement", "DirectDebitUK", "Domicil", "LastschriftCH", "RID", "OrdenDeDomiciliacion"]  # noqa: E501
