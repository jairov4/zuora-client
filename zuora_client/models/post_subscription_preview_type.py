...
class POSTSubscriptionPreviewType(object):
    ...
    def __init__(self, account_key=None, contract_effective_date=None, customer_acceptance_date=None, include_existing_draft_doc_items=None, include_existing_draft_invoice_items=None, initial_term=None, initial_term_period_type=None, invoice_owner_account_key=None, invoice_target_date=None, notes=None, preview_account_info=None, preview_type=None, service_activation_date=None, subscribe_to_rate_plans=None, target_date=None, term_start_date=None, term_type=None):  # noqa: E501
        """POSTSubscriptionPreviewType - a model defined in Swagger"""  # noqa: E501
    ...
    def initial_term(self):
        ...
        Duration of the first term of the subscription, in whole months. Default is `0`. If `termType` is `TERMED`, then this field is required, and the value must be greater than `0`. If `termType` is `EVERGREEN`, this field is ignored.   # noqa: E501
    ...
    def initial_term_period_type(self):
        ...
        The period type of the initial term.   Supported values are:  * `Month` * `Year` * `Day` * `Week`   # noqa: E501
