...
class CreditMemoItemBreakdown(object):
    ...
    def __init__(self, amount=None, apply_to_charge_number=None, breakdown_details=None, charge_number=None, credit_memo_item_id=None, end_date=None, start_date=None, subscription_number=None):  # noqa: E501
