...
class CreditMemoFromChargeDetailType(object):
    ...
    swagger_types = {
        ...
        'charge_id': 'str',
        'comment': 'str',
        'finance_information': 'CreditMemoFromChargeDetailTypeFinanceInformation',
    ...
    def __init__(self, amount=None, charge_id=None, comment=None, finance_information=None, memo_item_amount=None, service_end_date=None, service_start_date=None):  # noqa: E501
        """CreditMemoFromChargeDetailType - a model defined in Swagger"""  # noqa: E501
    ...
    def amount(self):
        ...
        The amount of the credit memo item.  This field is in Zuora REST API version control. Supported minor versions are `224.0` and later. To use this field in the method, you must set the `zuora-version` parameter to the request header.   # noqa: E501
    ...
    def charge_id(self):
        ...
        The ID of the product rate plan charge that the credit memo is created from.   # noqa: E501
    ...
    def finance_information(self):
        ...
        :rtype: CreditMemoFromChargeDetailTypeFinanceInformation
        """
    ...
    def memo_item_amount(self):
        ...
        The amount of the credit memo item.  This field is in Zuora REST API version control. Supported minor versions are `223.0` and earlier.   # noqa: E501
