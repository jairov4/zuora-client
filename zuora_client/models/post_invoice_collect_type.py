...
class POSTInvoiceCollectType(object):
    ...
    def __init__(self, account_key=None, document_date=None, invoice_date=None, invoice_id=None, invoice_target_date=None, payment_gateway=None, target_date=None):  # noqa: E501
