...
class UpdatePaymentType(object):
    ...
    def __init__(self, integration_id__ns=None, integration_status__ns=None, origin__ns=None, sync_date__ns=None, transaction__ns=None, comment=None, finance_information=None):  # noqa: E501
