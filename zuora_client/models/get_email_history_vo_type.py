...
class GETEmailHistoryVOType(object):
    ...
    def __init__(self, bcc=None, cc=None, error_message=None, event_category=None, from_email=None, notification=None, reply_to=None, result=None, send_time=None, subject=None, to_email=None):  # noqa: E501
