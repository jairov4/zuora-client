...
class ChargeOverride(object):
    ...
    def __init__(self, billing=None, charge_number=None, custom_fields=None, description=None, end_date=None, pricing=None, product_rate_plan_charge_id=None, start_date=None, unique_token=None):  # noqa: E501
