...
class POSTSubscriptionCancellationType(object):
    ...
    def __init__(self, apply_credit_balance=None, cancellation_effective_date=None, cancellation_policy=None, collect=None, invoice=None, invoice_collect=None, invoice_target_date=None, run_billing=False, target_date=None):  # noqa: E501
