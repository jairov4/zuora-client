...
class POSTSubscriptionPreviewCreditMemoItemsType(object):
    ...
    def __init__(self, amount_without_tax=None, charge_amount=None, charge_description=None, charge_name=None, product_name=None, product_rate_plan_charge_id=None, quantity=None, service_end_date=None, service_start_date=None, unit_of_measure=None):  # noqa: E501
