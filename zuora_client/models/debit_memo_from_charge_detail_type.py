...
class DebitMemoFromChargeDetailType(object):
    ...
    def __init__(self, amount=None, charge_id=None, comment=None, finance_information=None, memo_item_amount=None):  # noqa: E501
    ...
    def amount(self):
        ...
        The amount of the debit memo item.  This field is in Zuora REST API version control. Supported minor versions are `224.0` and later. To use this field in the method, you must set the `zuora-version` parameter to the request header.   # noqa: E501
    ...
    def memo_item_amount(self):
        ...
        The amount of the debit memo item.  This field is in Zuora REST API version control. Supported minor versions are `223.0` and earlier.   # noqa: E501
