...
class GETDebitMemoItemTypewithSuccess(object):
    ...
    def __init__(self, amount=None, amount_without_tax=None, balance=None, be_applied_amount=None, comment=None, created_by_id=None, created_date=None, finance_information=None, id=None, service_end_date=None, service_start_date=None, sku=None, sku_name=None, source_item_id=None, source_item_type=None, subscription_id=None, tax_items=None, updated_by_id=None, updated_date=None):  # noqa: E501
