...
class POSTPublicEmailTemplateRequest(object):
    ...
    def __init__(self, active=True, bcc_email_address=None, cc_email_address=None, cc_email_type='SpecificEmails', description=None, email_body=None, email_subject=None, encoding_type='UTF8', event_type_name=None, from_email_address=None, from_email_type=None, from_name=None, is_html=False, name=None, reply_to_email_address=None, reply_to_email_type=None, to_email_address=None, to_email_type=None):  # noqa: E501
    ...
    def event_type_name(self):
        ...
        The name of event type  # noqa: E501
