# zuora_client.PaymentMethodSnapshotsApi
...
> ProxyDeleteResponse object_delete_payment_method_snapshot(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id)
...
api_instance = zuora_client.PaymentMethodSnapshotsApi()
...
try:
    # CRUD: Delete PaymentMethodSnapshot
    api_response = api_instance.object_delete_payment_method_snapshot(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PaymentMethodSnapshotsApi->object_delete_payment_method_snapshot: %s\n" % e)
```
